...
// I added this revised function to replace the above one on 4/15.  ************************************* JL 
 ...
 var newWidth;
  switch(size) {
    ...
    case "3":
      ...
      break;
    default:
    console.log("sizeSwitcher function problem");
